...
*********************************************************************/
#ifndef LOCATORBUILDER_H__
#define LOCATORBUILDER_H__
...
class LocatorBuilder : public ResourceBuilder
{
public:
	LocatorBuilder();
	~LocatorBuilder();
...
private:
	...
	Heart::Scene::SceneNodeLocator		locatorNode_;

};

#endif // LOCATORBUILDER_H__