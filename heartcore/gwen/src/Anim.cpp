...
Gwen::Anim::Animation::List& GetAnimations()
{
    static Gwen::Anim::Animation::List	g_Animations;
    return g_Animations;
}

Gwen::Anim::Animation::ChildList& GetAnimationsListed()
{
    static Gwen::Anim::Animation::ChildList g_AnimationsListed;
    return g_AnimationsListed;
}
...
void Gwen::Anim::Add( Gwen::Controls::Base* control, Animation* animation )
{
	...
	GetAnimations()[control].push_back( animation );
}
...
void Gwen::Anim::Cancel( Gwen::Controls::Base* control )
{
	...
	*/
	...
	if ((iAnimations = GetAnimations().find(control)) != GetAnimations().end())
	{
		...
		GetAnimations().erase(iAnimations);
	}
}

void Gwen::Anim::Think()
{
	Gwen::Anim::Animation::List::iterator it = GetAnimations().begin();
