...
#define HEART_MAX_TAG_IDS        (32)
    ...
    struct HEARTCORE_SLIBEXPORT hJobBuffer
    {
        void*   ptr_;
        hUint32 size_;
    };
    ...
    struct HEARTCORE_SLIBEXPORT hJobTagBatch
    {
        hAtomicInt  jobsCompleted_;
        hUint32     jobsToComplete_;
        hUint32     firstJob_;
        hBool       batchPushed_;
    }HEART_ALIGNMENT_END(32);

    struct HEARTCORE_SLIBEXPORT hJobDesc
    {
	...
	class HEARTCORE_SLIBEXPORT hJob
	{
    public:
		hJob() {}
        ~hJob() {}
    ...
    class HEARTCORE_SLIBEXPORT hJobChain
    {
    public:
    ...
    private:
        ...
        hJobChain& operator = ( const hJobChain& ) { return *this;}
    };

	class HEARTCORE_SLIBEXPORT hJobManager
	{
	public:
		hJobManager();
		virtual ~hJobManager();
	...
	private:
        ...
        hAtomicInt              sleepingJobThreads_;
        hAtomicInt              jobReadIndex_;
        hAtomicInt              jobWriteIndex_;
