...
namespace Heart
{
    ...
    void hdDX11RenderSubmissionCtx::Map( hdDX11IndexBuffer* ib, hdDX11MappedResourceData* data )
    {
        ...
        device_->Map( ib->buffer_, 0, D3D11_MAP_WRITE_DISCARD, 0, data );
    }
    ...
    void hdDX11RenderSubmissionCtx::Map( hdDX11VertexBuffer* vb, hdDX11MappedResourceData* data )
    {
        ...
        device_->Map( vb->buffer_, 0, D3D11_MAP_WRITE_DISCARD, 0, data );
    }
    ...
    void hdDX11RenderSubmissionCtx::Unmap( hdDX11Texture* tex, hUint32 level )
    {
    ...
    void hdDX11RenderSubmissionCtx::Unmap( hdDX11IndexBuffer* ib )
    {
    ...
    void hdDX11RenderSubmissionCtx::Unmap( hdDX11VertexBuffer* vb )
    {
