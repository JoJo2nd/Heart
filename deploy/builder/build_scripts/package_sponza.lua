...
--
shaders={
    {path="src://shaders/gbuffer.hlsl", res="GBUFFER_VS", params={entry="vertexMain", profile="vs_5_0", warningsaserrors=true}},
    {path="src://shaders/gbuffer.hlsl", res="GBUFFER_PS", params={entry="pixelMain", profile="ps_5_0", warningsaserrors=true}},
    {path="src://shaders/gbuffer.hlsl", res="GBUFFER_NO_NRM_VS", params={entry="vertexMain", profile="vs_5_0", defines={NO_NORMAL_MAP="1"}, warningsaserrors=true}},
    {path="src://shaders/gbuffer.hlsl", res="GBUFFER_NO_NRM_PS", params={entry="pixelMain", profile="ps_5_0", defines={NO_NORMAL_MAP="1"}, warningsaserrors=true}},
}
