...
private:
    ...
    void onPkgSelectFocus(wxFocusEvent& evt);
    void onPkgSelectItem(wxCommandEvent& evt);
    void onSourceFileChange(wxFileDirPickerEvent& evt);
    void onLodLevelSelect(wxCommandEvent& evt);
    void onMatSelectFocus(wxFocusEvent& evt);
    void onMatSelectItem(wxCommandEvent& evt);
