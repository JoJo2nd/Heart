...
const char* vPackage::getRootPath() const {
...
void vPackage::addPackageLink(vResource* res, vPackage* pkg, vResource* linkedRes) {
    impl_->addPackageLink(res, pkg, linkedRes);
}
...
void vResource::breakAllDependentLinks() {
    impl_->breakAllDependentLinks();
}
