...
static cyUint32    crc_table[256] = // CRC lookup table array.
{
...
#define DO1(buf)  *crc = CRC32(*crc, *(const unsigned char*)buf++)
...
void CY_API cyStartCRC32( cyUint32* incrc, const cyByte* data, cyUint32 len )
{
    *incrc = 0xffffffff;
    ...
    cyContinueCRC32( incrc, data, len );
}
//////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////
