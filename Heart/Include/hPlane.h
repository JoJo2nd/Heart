...
namespace Heart
{
	...
	public:
		...
		* @return   	void
		*/
		static inline void	buildPlane( const hVec3& a, const hVec3& b, const hVec3& c, hPlane& out )
		{
			hVec3 tmp;
			hVec3::cross( b - a, c - a, tmp );
			hVec3::normalise( tmp, out.n );
			out.d = hVec3::dot( out.n, a );
		}
		...
		* @return   	hBool
		*/
		static inline hBool pointBehindPlane( const hVec3& a, hPlane& p )
		{
