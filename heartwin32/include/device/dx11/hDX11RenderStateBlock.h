...
namespace Heart
{
    struct HEARTDEV_SLIBEXPORT hdDX11BlendState : public hIReferenceCounted,
    ...
    struct HEARTDEV_SLIBEXPORT hdDX11RasterizerState : public hIReferenceCounted,
    ...
    struct HEARTDEV_SLIBEXPORT hdDX11DepthStencilState : public hIReferenceCounted,
    ...
    struct HEARTDEV_SLIBEXPORT hdDX11InputState : public hIReferenceCounted,
    ...
    struct HEARTDEV_SLIBEXPORT hdDX11SamplerState : public hIReferenceCounted,
