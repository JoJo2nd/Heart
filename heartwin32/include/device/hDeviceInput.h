...
namespace Device
{
    ...
    struct HEARTDEV_SLIBEXPORT InputButton
	{
		InputButton() :
			buttonVal_( hFalse )
			,raisingEdge_( hFalse )
	...
	struct HEARTDEV_SLIBEXPORT InputAxis
	{
		InputAxis() : 
			anologueVal_( 0.0f ) 
		{}
	...
	class HEARTDEV_SLIBEXPORT IInput
	{
	public:
		IInput() {}
		virtual ~IInput() {}
	...
	struct HEARTDEV_SLIBEXPORT InputBufferData
	{
		InputID			buttonID_;
		InputState		state_;
	};
	...
	class HEARTDEV_SLIBEXPORT IBufferedInput : public IInput
	{
	public:
	...
	class HEARTDEV_SLIBEXPORT ICharacterInput
	{
	public: 
