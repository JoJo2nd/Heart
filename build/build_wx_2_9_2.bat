...
devenv ..\external\wxWidgets-2.9.2\build\msw\wx_%VSTYPE%.sln /Build "Universal Debug|Win32"
devenv ..\external\wxWidgets-2.9.2\build\msw\wx_%VSTYPE%.sln /Build "Universal Release|Win32"