...
function(_protobuf_find_libraries name filename)
    if( ${CMAKE_SIZEOF_VOID_P} MATCHES 4 )
        set( PB_BUILD_64_BIT 0 )
        set( PB_LIB_VIR_PREFIX )
    else()
        set( PB_BUILD_64_BIT 1 )
        set( PB_LIB_VIR_PREFIX "x64/")
    endif()

   find_library(${name}_LIBRARY
       NAMES ${filename}
       PATHS ${PROTOBUF_SRC_ROOT_FOLDER}/vsprojects/${PB_LIB_VIR_PREFIX}Release)
   mark_as_advanced(${name}_LIBRARY)

   find_library(${name}_LIBRARY_DEBUG
       NAMES ${filename}
       PATHS ${PROTOBUF_SRC_ROOT_FOLDER}/vsprojects/${PB_LIB_VIR_PREFIX}Debug)
