...
IF exist "%ASSIMP_FOLDER_R%" ROBOCOPY "%ASSIMP_FOLDER_R%" "%GAME_BIN_FOLDER%" "*.dll" "*.pdb" %ROBOCOPY_OPTIONS%
IF exist "%ASSIMP_FOLDER_D%" ROBOCOPY "%ASSIMP_FOLDER_D%" "%GAME_BIN_FOLDER%" "*.dll" "*.pdb" %ROBOCOPY_OPTIONS%

ROBOCOPY "%NVIDIA_TEX_TOOLS_FOLDER%" "%TOOLS_BIN_FOLDER%" "*.dll" %ROBOCOPY_OPTIONS%
ROBOCOPY "%NVIDIA_TEX_TOOLS_FOLDER2%" "%TOOLS_BIN_FOLDER%" "*.dll" %ROBOCOPY_OPTIONS%
IF exist "%ASSIMP_FOLDER_R%" ROBOCOPY "%ASSIMP_FOLDER_R%" "%TOOLS_BIN_FOLDER%" "*.dll" "*.pdb" %ROBOCOPY_OPTIONS%
IF exist "%ASSIMP_FOLDER_D%" ROBOCOPY "%ASSIMP_FOLDER_D%" "%TOOLS_BIN_FOLDER%" "*.dll" "*.pdb" %ROBOCOPY_OPTIONS%
