...
REM ROBOCOPY "%NVIDIA_TEX_TOOLS_FOLDER%" "%TOOLS_BIN_FOLDER%" "*.dll" %ROBOCOPY_OPTIONS%
REM ROBOCOPY "%NVIDIA_TEX_TOOLS_FOLDER2%" "%TOOLS_BIN_FOLDER%" "*.dll" %ROBOCOPY_OPTIONS%
REM IF exist "%ASSIMP_FOLDER_R%" ROBOCOPY "%ASSIMP_FOLDER_R%" "%TOOLS_BIN_FOLDER%" "*.dll" "*.pdb" %ROBOCOPY_OPTIONS%
REM IF exist "%ASSIMP_FOLDER_D%" ROBOCOPY "%ASSIMP_FOLDER_D%" "%TOOLS_BIN_FOLDER%" "*.dll" "*.pdb" %ROBOCOPY_OPTIONS%
