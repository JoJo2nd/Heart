...
IF exist "%HEART_BIN_FOLDER_D%" ROBOCOPY "%HEART_BIN_FOLDER_D%" "%GAME_BIN_FOLDER%" "*.dll" "*.exe" "*.pdb" %ROBOCOPY_OPTIONS%
IF exist "%HEART_BIN_FOLDER_R%" ROBOCOPY "%HEART_BIN_FOLDER_R%" "%GAME_BIN_FOLDER%" "*.dll" "*.exe" "*.pdb" %ROBOCOPY_OPTIONS%
