...
REM v1 set TOOLDEPLOY_BIN_FOLDER=%TOOLS_BIN_FOLDER%
set TOOLDEPLOY_BIN_FOLDER=%TOOLS_BIN_FOLDER%%2/
REM v1 set TOOLDEPLOY_BIN_FOLDER_D=%TOOLS_BIN_FOLDER%
set TOOLDEPLOY_BIN_FOLDER_D=%TOOLDEPLOY_BIN_FOLDER%debug
REM v1 set TOOLDEPLOY_BIN_FOLDER_R=%TOOLS_BIN_FOLDER%
set TOOLDEPLOY_BIN_FOLDER_R=%TOOLDEPLOY_BIN_FOLDER%release
