...
outString += "#    define hFUNCTOR_TYPEDEF_T(ty, tydef) typedef typename Heart::hFunctor< ##ty >::type tydef\n"
outString += "#elif defined (HEART_PLAT_LINUX)\n"
outString += "#    define hFUNCTOR_TYPEDEF(ty, tydef) typedef typename Heart::hFunctor< ty >::type tydef\n"
outString += "#    define hFUNCTOR_TYPEDEF_T(ty, tydef) hFUNCTOR_TYPEDEF(ty, tydef)\n"
outString += "#endif\n"
