...
namespace Heart
{
    ...
    void hdW32Thread::create(const hChar* threadName, hInt32 priority, hThreadFunc pFunctor, void* param)
    {
    ...
    void hdW32Thread::SetThreadName(LPCSTR szThreadName)
    {
#pragma pack ( push,8 )
...
#pragma pack ( pop )
    ...
    unsigned long WINAPI hdW32Thread::staticFunc(LPVOID pParam)
    {
        hdW32Thread* pThis_ = (hdW32Thread*)pParam;
