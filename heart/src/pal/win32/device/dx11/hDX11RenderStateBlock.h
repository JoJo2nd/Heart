...
namespace Heart
{
    struct HEART_DLLEXPORT hdDX11BlendState
    {
        hdDX11BlendState() 
            : stateObj_(NULL)
        {
    ...
    struct HEART_DLLEXPORT hdDX11RasterizerState
    {
    ...
    struct HEART_DLLEXPORT hdDX11DepthStencilState
    {
    ...
    struct HEART_DLLEXPORT hdDX11SamplerState
    {
        hdDX11SamplerState()
            : stateObj_(NULL)
        {
