...
#include "device/dx11/hDX11Texture.h"
#include "device/dx11/hDX11RenderStateBlock.h"
#include "device/dx11/hDX11RenderSubmissionCtx.h"
#include "device/dx11/hDX11RenderDevice.h"
...
namespace Heart 
{
    ...
    typedef hdDX11RenderStreamsObject    hdRenderStreamsObject;
