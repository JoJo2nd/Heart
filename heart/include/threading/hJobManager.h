...
#define HEART_MAX_TAG_IDS        (32)
    ...
    struct HEART_DLLEXPORT hJobBuffer
    {
        void*   ptr_;
        hUint32 size_;
    };
    ...
    struct HEART_DLLEXPORT hJobTagBatch
    {
    ...
    struct HEART_DLLEXPORT hJobDesc
    {
    ...
    class HEART_DLLEXPORT hJobChain
    {
    public:
