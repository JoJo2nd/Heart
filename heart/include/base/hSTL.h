...
namespace Heart
{
    ...
    public:
        ...
        {	// allocate array of _Count elements
            return (pointer)hMalloc(sizeof(value_type)*_Count);
        }
	...
	class string : public std::basic_string< char, std::char_traits<char>, HeapAllocator< char > >
	{
	public:
		string()
		{
	...
	class deque : public std::deque< _Ty, HeapAllocator< _Ty > >
	{
	public:
		deque() {}
	private:
