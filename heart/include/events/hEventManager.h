...
namespace Heart
{
    ...
    public:
        ...
        typedef typename hFunctor< void(*)( hUint32, _Ty& ) >::type Delegate;
    ...
    ************************************************************************/
    ...
    {
    public:
        typedef hFunctor PublishDelegate;

        hPublisher() 
        {

        }
        hPublisher(const hPublisher& rhs)
        {
        }
        hPublisher& operator(const hPublisher& rhs)
        {
            return *this;
        }
        ~hPublisher()
        ...
        void operator () (hPublisherContext*)
        {
        }
